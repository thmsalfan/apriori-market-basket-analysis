...
if ($login == 1) {
    $komen = "Silahkan Coba Login Ulang";
}
                            ...
                            <div class="widget-body">
                                ...
                                ?>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p class="lead">
                                            Penerapan Data mining dalam penjualan produk dengan menggunakan Algoritma Apriori pada Toko XYZ
                                        </p>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <form method="post" action="cek-login.php" >
                                            <fieldset>
                                                ...
                                                <div class="clearfix">
                                                    <a href="cek.php">Reset Password</a>
