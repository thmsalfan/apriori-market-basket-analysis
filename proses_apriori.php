    ...
    <form method="post" action="">
        <div class="row">
            ...
            <div class="col-lg-6 " >
                <div class="form-group">
                    <label>Min Support :</label>
                    <input name="min_support" type="text" class="form-control" placeholder="Harap Diisi Angka">
                </div>
                <div class="form-group">
                    <label>Min Confidence :</label>
                    <input name="min_confidence" type="text" class="form-control" placeholder="Harap Diisi Angka">
                </div>
                <div class="form-group">
                    <input name="submit" type="submit" value="Proses" class="btn btn-success">
                </div>
